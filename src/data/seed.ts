...
export const SEED_USERS: Omit<User, 'id'>[] = [
  { tenant_id: T, email: 'alfonsoavilery@icloud.com', full_name: 'Alfonso Avilery', role: 'admin_restaurant', sucursal_id: S, is_active: true, created_at: new Date().toISOString() },
